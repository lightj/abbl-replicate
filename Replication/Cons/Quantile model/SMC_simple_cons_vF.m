% ABBL (2023)
% Code to estimate the baseline non-linear consumption model with latent earnings but no heterogeneity
...
global T N K1 K2 K3 K4 K5 Ntau Vectau tau AGE1 Y1 A1...
    ...
    AGE_tot M1 M2 M3 M4 M5 M6 M7 M8 M9 M10 M11 M12 M13 M14 M15 M16 M17 MatXi MatClag Matdraw MatA MatAlag...
    uc Vect_AGE_tot Vect_A_tot Vect_AGE_t Vect_A_lag Vect_Matdraw_lag Vect_Y_lag Vect_C_lag ua ua1 Vect_AGE1...
    Vect_Matdraw1 meanexpY stdexpY meanexpC stdexpC unit_assets min_val max_val A_tot_RHS Vect_YB Vect_ED;

%%
% 1. Parameters
%%%%%%%%%%%%

%%% whether there is an asset rule
asset_rule=1;
...
M3=1;
M4=1;
% M5 is only used in the specification with heterogeneity
...
M9=1;
M10=1;
% M11 is only used in the specification with heterogeneity

%%% xi equation (NOT USED IN SMC)
% M12, M12a and M12b are only used in the specification with heterogeneity

%%% initial assets equation
M13=1;
M14=1;
% M15 is only used in the specification with heterogeneity
M16 = 1;
M17 = 1;

%%% numerical parameters
tol_dnom=2; % Resampling tolerance
maxiter=100; % Stochastic EM iterations
Nis_scale=100; % Scaling parameter for importance samples
...
load ('/home/jdlight/ABBL_PMCMC/JOE_codes/Results/211015_smc_l.mat')
...
Resqnew_a1=zeros((M13+1)*(M14+1)*(M16+1)*(M17+1),Ntau,maxiter);
...
% save '/home/jdlight/ABBL_PMCMC/JOE_codes/Replication/Cons/Quantile model/Results/REVISION_cons_smc_l.mat'
